...
class YeastBio(data.ProteinDataset):
    ...
    txt_file = '/home/oqueen/deep-surface-protein-data/yeast_bio.txt'
    pkl_file = '/om2/user/oqueen/DeepSurface/data/splits2.pkl'
...
# Load one split:
data_path = '/om2/user/oqueen/DeepSurface/data/'
